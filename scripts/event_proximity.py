...
duckdb.sql(f"""
                    ...
                    --PITCH_THIRD_ADJ, PITCH_THIRD_END_ADJ, PROGRESS_TYPE, 
                    DISTANCE_TRAVELED, 
                    STARTING_DISTANCE_TO_GOAL_SHOOTING_ON, STARTING_DISTANCE_TO_GOAL_DEFENDING, 
                    PROGRESS_TO_GOAL_SHOOTING_ON, --PROGRESS_TO_GOAL_DEFENDING,
                    PITCH_ORIENTATION, 
                    DIST_TO_GOAL, 
                    --GOAL_AREA_DIST, --PROX_BOX, 
                    --THIRDS_ADVANCED, 
                    HORIZONTAL_BOX || VERTICAL_BOX EVENT_ZONE_START , 
                    HORIZONTAL_BOX_END || VERTICAL_BOX_END EVENT_ZONE_END
                    FROM event_zones
                    """).write_parquet(output_path)
print('Event Proximity Done.')