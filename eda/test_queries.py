...
y_coords = duckdb.sql(f"""
                      ...
                      --,
                        ...
                        SELECT correct_cross.player_id , SUM(MINUTES_ON_PITCH) MINUTES_ON_PITCH, SUM(pass_attempt) pass_attempt, SUM(pass_through_ball_attempts) pass_through_ball_attempts,
                        SUM(pass_attempt) / SUM(MINUTES_ON_PITCH) pass_attempts_per_minute, SUM(pass_through_ball_attempts) / SUM(MINUTES_ON_PITCH) pass_through_ball_attempts_per_minute,
                        ...
                        ORDER BY MINUTES_ON_PITCH DESC
                     """)
print(y_coords)
